...
PKCT_REPORT_PATH =  PROJECT_DIR / config_data['PKCT_REPORT_PATH'].lstrip('/')
...
HMI_REPORT = os.path.join(PROJECT_DIR, "hmi", "CVEHMI", "hmiapp", "media", "reports", "download")
if not os.path.exists(HMI_REPORT):
      os.makedirs(HMI_REPORT)
